...
public class DetailSell extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Sellprice = findViewById(R.id.sprice);
        ...
        if (bundle != null) {
            ...
            String price = bundle.getString("SellingPrice");
...
//         TextView edit = findViewById(R.id.edititems);
//        edit.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                Intent intent1 = new Intent(DetailSell.this , EditSell.class)
//                        .putExtra("name" , title1.getText().toString())
//                        .putExtra("description" , desc.getText().toString())
//                        .putExtra("SellingPrice" , Sellprice.getText().toString())
//                        .putExtra("OriginalPrice" , oprice.getText().toString())
//                        .putExtra("photoUrl" , String.valueOf(image1))
//                        .putExtra("id" , key);
            ...
            public void onClick(View v) {
                ...
                documentReference.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        Toast.makeText(DetailSell.this, "Item Deleted", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(DetailSell.this, "Error Deleting Item", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                });
            }
